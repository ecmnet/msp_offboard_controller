...
{
  double dec_phase_secs = (deceleration_phase_secs == 0 || deceleration_phase_secs > DECELERATION_PHASE_SECS) ?
                                                        ...
                                                        const double angle_variation)
{
  ...
  if (estimated_time < (acceleration_phase_s + deceleration_phase_secs + MIN_VELOCITY))
  {
